package com.zyh.rocket.aliyun.support.consumer;

import com.zyh.rocket.aliyun.core.consumer.AliyunBatchConsumerListener;
import com.zyh.rocket.aliyun.core.consumer.AliyunCommonConsumerListener;
import com.zyh.rocket.aliyun.core.consumer.AliyunOrderConsumerListener;
import com.zyh.rocket.aliyun.support.consumer.container.BatchRocketConsumerContainer;
import com.zyh.rocket.aliyun.support.consumer.container.CommonRocketConsumerContainer;
import com.zyh.rocket.aliyun.support.consumer.container.OrderRocketConsumerContainer;
import com.zyh.rocket.base.annotation.listener.RocketMessageListener;
import com.zyh.rocket.base.config.RocketProperties;
import com.zyh.rocket.base.core.consumer.RocketConsumerListener;
import com.zyh.rocket.base.state.MessageModelState;
import com.zyh.rocket.base.support.container.AbstractConsumerContainer;
import com.zyh.rocket.base.support.AbstractConsumerContainerSupport;
import com.zyh.rocket.base.serializer.base.RocketSerializer;
import com.zyh.rocket.base.utils.AspectUtils;
