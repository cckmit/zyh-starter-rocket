package com.zyh.rocket.aliyun.config;

import com.zyh.rocket.aliyun.support.AliRocketMqTemplate;
import com.zyh.rocket.aliyun.support.consumer.DefaultConsumerContainerSupport;
import com.zyh.rocket.aliyun.support.producer.CommonMessageProducerContainerSupport;
import com.zyh.rocket.aliyun.support.producer.OrderMessageProducerContainerSupport;
import com.zyh.rocket.aliyun.support.producer.TransactionMessageProducerContainerSupport;
import com.zyh.rocket.aliyun.support.producer.defaults.checker.DefaultLocalCommitTransactionChecker;
import com.zyh.rocket.aliyun.support.producer.defaults.checker.DefaultLocalRollbackTransactionChecker;
import com.zyh.rocket.aliyun.support.producer.defaults.checker.DefaultLocalUnknowTransactionChecker;
import com.zyh.rocket.aliyun.support.producer.defaults.executer.DefaultLocalTransactionExecuter;
import com.zyh.rocket.aliyun.support.producer.defaults.callback.DefaultSendCallback;
import com.zyh.rocket.base.annotation.EnableRocketMQ;
import com.zyh.rocket.base.config.RocketAutoConfiguration;
import com.zyh.rocket.base.config.RocketProperties;
import com.zyh.rocket.base.serializer.DefaultJsonSerializer;
import com.zyh.rocket.base.utils.ResolvePlaceholdersUtil;
