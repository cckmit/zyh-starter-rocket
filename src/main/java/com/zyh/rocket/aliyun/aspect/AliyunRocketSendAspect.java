package com.zyh.rocket.aliyun.aspect;

import com.zyh.rocket.base.config.RocketProperties;
import com.zyh.rocket.base.aspect.RocketSendAspectCore;
...
public class AliyunRocketSendAspect extends RocketSendAspectCore {
	 ...
	 * 消息切入点
	 */
	@Pointcut("@annotation(com.zyh.rocket.aliyun.annotation.send.CommonMessage)||" +
		"@annotation(com.zyh.rocket.aliyun.annotation.send.OrderMessage)||" +
		"@annotation(com.zyh.rocket.aliyun.annotation.send.TransactionMessage)")
