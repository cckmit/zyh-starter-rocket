package com.zyh.rocket.base.support.container;


import com.zyh.rocket.base.config.RocketProperties;
import com.zyh.rocket.base.core.consumer.RocketConsumerListener;
import com.zyh.rocket.base.error.RocketAccessException;
import com.zyh.rocket.base.error.RocketIdempotentException;
import com.zyh.rocket.base.helper.MessageAttributes;
import com.zyh.rocket.base.helper.listener.ListenerHelper;
import com.zyh.rocket.base.helper.listener.ListenerHelperProcessor;
import com.zyh.rocket.base.helper.util.ProcessorUtil;
import com.zyh.rocket.base.serializer.base.RocketSerializer;
import com.zyh.rocket.base.utils.ResolvePlaceholdersUtil;
import com.zyh.rocket.base.utils.RocketSpringUtil;
import com.zyh.rocket.base.utils.RocketThreadLocalUtil;
import lombok.Data;
...
public abstract class AbstractConsumerContainer<T, A> implements DisposableBean {
	...
	public AbstractConsumerContainer(RocketProperties rocketProperties, RocketSerializer serializer, RocketConsumerListener<T, A> actingListener, Class<T> messageType, Class<A> returnType, String groupId, String topic, String tag) {
		...
		if (listenerHelper != null) {
			...
			this.businessType = resolvePlaceholdersUtil.resolvePlaceholders(listenerHelper.exBusinessType(), listenerHelper.businessType());
		}
